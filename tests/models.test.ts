...
test('source erasure sends the compact strict schema to the verification model',async()=>{
 const reply={decisions:[{index:0,effect:'mixed',erase_quotes:['My backup is Iris.'],reason:'mixed_source'}]};
