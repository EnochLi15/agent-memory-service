...
export type Prepared = { sourceOperationPlan?:import('./source-operations.js').SourceOperationPlan; facts: Fact[]; operations: Operation[]; messages: StoredMessage[]; passages?:Passage[]; sourceFormat?:'dual-source-v2'|'facts-only-v2'|'dual-source-v3'|'facts-only-v3'|'dual-source-v4'|'facts-only-v4'|'dual-source-v5'|'facts-only-v5'|'dual-source-v6'|'facts-only-v6'; erasurePlan?:ErasurePlan;sourceErasurePlan?:SourceErasurePlan;transitionPlan?:TransitionPlan; anchor: string | null; degraded: string[]; embeddingSpace: string };
