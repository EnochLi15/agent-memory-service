...
export interface Config {
  ...
  erasureBinding:boolean;sourceErasure:boolean;semanticTransitions:boolean;sourceOperations:boolean;sourceOperationHistory:boolean;sourceOperationBatches:boolean;
...
export function configFromEnv(env: NodeJS.ProcessEnv = process.env): Config {
  ...
  return {
    ...
    sourceOperations:env.MEMORY_SOURCE_OPERATIONS==='true',sourceOperationHistory:env.MEMORY_SOURCE_OPERATION_HISTORY==='true',sourceOperationBatches:env.MEMORY_SOURCE_OPERATION_BATCHES==='true',
